...
const Content = ({ activeData }) => {
  ...
  return (
    <div className="select-none w-full h-2/5 flex justify-center items-center  lg:w-1/2 lg:h-full ">
      <div className=" flex justify-start flex-col items-start">
        <h1 className="content text-left text-5xl font-bold mb-1 md:text-8xl md:mb-2">
          Minimalistic
        </h1>
